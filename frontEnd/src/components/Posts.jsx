...
const Posts = () => {
  ...
  return (
    ...
    {posts.map((item)=>(
      ...
      <div className="line-clamp-3"><p className="block mt-3 font-sans text-xl antialiased font-normal leading-relaxed text-gray-700 text-left">
        {item.description}
      </p>
      </div>
      <button className="bg-blue-400 text-white rounded-md p-1 m-2">Readmore...</button>

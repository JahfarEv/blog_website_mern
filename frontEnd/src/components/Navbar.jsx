...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full top-0 left-0">
      <nav className="block w-full max-w-screen-xl px-6 py-3 mx-auto text-white bg-blue-800 border shadow-md rounded-xl border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200">
